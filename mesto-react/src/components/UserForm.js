...
export default function UserForm({ title, buttonText, onSubmit, children }) {
  ...
  return (
    <div className="user-form">
      ...
      <form className="user-form__form">
        {children}
        <button className="user-form__button-submit" type="submit" onClick={onSubmit} disabled={false}>
          {buttonText}
        </button>
      </form>
    </div>
